...
public class AppTests extends TestBase {
    ...
    void generatedTest() {
        step("открыть https://www.pepper.ru/", () -> {
    ...
    void titleTest() {
        step("Open url 'https://www.pepper.ru/'", () ->
            open("https://www.pepper.ru/"));

        step("Page title should have text 'Pepper.ru - лучшие скидки и промокоды в России'", () -> {
            String expectedTitle = "Pepper.ru - лучшие скидки и промокоды в России";
